...
(function () {
  ...
  function steps() {
    ...
    return [
      ...
      { view: 'dashboard', sel: ['[data-menu="notifs"]', '.tn-burger'],
        title: 'Notifications that are true',
        text: 'The bell isn\'t decoration — it counts unread messages, urgent tickets, overdue tasks and ' + t.deals.toLowerCase() + ' closing this week, straight from the records. Click it after the tour.' },
      { view: 'contacts', sel: '.tbl-wrap',
        title: 'Contacts',
        text: 'Every row opens a full record, the view tabs and filters really filter, and the Create contact button makes a real record that every screen counts. Try it after the tour.' },
